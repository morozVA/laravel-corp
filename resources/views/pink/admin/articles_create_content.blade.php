    ...
    <div class="hentry group">
        ...
        <ul>
            ...
            <li class="text-field">
                ...
                <div class="input-prepend"><span class="add-on"><i class="icon-user"></i></span>
                    {!! Form::text('keywords', isset($article->keywords) ? $article->keywords  : old('keywords'), ['placeholder'=>'Введите ключевые cлова страницы']) !!}
                </div>
            </li>
            ...
            <li class="text-field">
                ...
                <div class="input-prepend"><span class="add-on"><i class="icon-user"></i></span>
                    {!! Form::text('meta_desc', isset($article->meta_desc) ? $article->meta_desc  : old('meta_desc'), ['placeholder'=>'Введите описание страницы']) !!}
                </div>
            </li>
